...
return [
    ...
    */
    ...
    'emails' => [
        'auth' => [
            'account_confirmed' => 'Il tuo account è stato autenticato con successo. Puoi accedere con le credenziali scelte durante l\'iscrizione, completare il tuo profilo e cercare opportunità di lavoro.',
            'error' => 'Whoops!',
            'greeting' => 'Ciao!',
            'Regards' => 'Un caro saluto,<br>Staff<br>SpiderGain',
            'trouble_clicking_button' => 'Se hai problemi con il bottone ":action_text", copia e incolla l\'Url nel tuo browser:',
            'thank_you_for_using_app' => 'Grazie per usare il nostro portale!',

            'password_reset_subject' => 'Il tuo link per il reset della password',
            'password_cause_of_email' => 'Stai ricevendo questa email perchè abbiamo ricevuto un richiesta di reset password per il tuo account.',
            'password_if_not_requested' => 'Se non hai richiesto il reset della password ignora questa email',
            'reset_password' => 'Clicca qui per resettare la tua password',
            'click_to_confirm' => 'Gentile :name :surname, grazie per esserti iscritto al nostro portale, la tua iscrizione è quasi completata. Per terminare l\'iscrizione, attivare il tuo account ed iniziare da subito a guadagnare, clicca sul pulsante:',
