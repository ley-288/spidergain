    ...
    'frontend' => [
        'auth' => [
            'confirmation' => [
                ...
                'created_confirm' => "Gentile :name :surname, grazie per esserti iscritto al nostro portale, la tua iscrizione è quasi completata. <br>Manca un solo passaggio per poter iniziare a guadagnare. <br>Ti abbiamo mandato una e-mail con la quale devi confermare la tua iscrizione. <br>Questo passaggio è necessario, perché noi di Spidergain ci teniamo molto alla sicurezza dei nostri utenti.<br> Accedi ora al tuo account e-mail e conferma la tua iscrizione. 
                   <br> Un caro saluto<br><br>
                    Staff
                    SpiderGain",
                ...
                'success' => 'Il tuo account è stato autenticato con successo. Puoi accedere con le credenziali scelte durante l’iscrizione, completare il tuo profilo e cercare opportunità di lavoro',
